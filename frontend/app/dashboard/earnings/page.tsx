...
const payouts = [
  ...
  { id: "p-904", task: "Analytics warehouse review", date: "May 28", amount: 1600, status: "Processing" },
]
...
export default function ClientEarningsPage() {
  ...
  return (
    <AppShell role="client" userName={userName}>
      <PageHeader
        title="Payments & Spend"
        subtitle="Track your task expenditures and escrow balances."
        action={
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-[1fr_380px]">
        <Card className="p-6">
          <h2 className="font-heading text-base font-semibold">Spend this year</h2>
